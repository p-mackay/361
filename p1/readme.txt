...
- Uses classes made the code much cleaner, and easier to read.
...
keep the connection alive. It was a very ridged design that only accepted requests in batch files. And 
even then did not handle requests properly.
